...
@Service
public class NationalListService extends _AbstractService<UUID, NationalListRequest, NationalListResponse, NationalList, NationalListRepository, NationalListMapper> {
