...
import com.electify.services.spec.ICityService;
import org.springframework.stereotype.Service;

import java.util.UUID;

@Service
public class CityService extends _AbstractService<UUID, CityRequest, CityResponse, City, CityRepository, CityMapper> implements ICityService {
